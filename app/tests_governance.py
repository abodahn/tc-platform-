...
NEW_I18N = {
 ...
 "gov.find.uncheckable": ("This check could not be run — the result below is NOT an all-clear.",
                          "تعذّر تنفيذ هذا الفحص — ما يظهر أدناه ليس إقرارًا بسلامة الوضع.",
                          "Bu denetim çalıştırılamadı — aşağıdaki sonuç bir “sorun yok” anlamına GELMEZ."),
